...
% tail plane airfoils.  Add more control surface deflections to improve.
    ...
    fnames = cell(3, 3);
    reynolds = [3 7 15]' * 1e5;
    delta = [-10.0 0.0 10.0]' * pi/180;
    fnames{1,1} = [dir 'wxtail-10re3e5.txt'];
    fnames{2,1} = [dir 'wxtail-10re7e5.txt'];
    fnames{3,1} = [dir 'wxtail-10re15e5.txt'];
    
    fnames{1,2} = [dir 'wxtail+0re3e5.txt'];
    fnames{2,2} = [dir 'wxtail+0re7e5.txt'];
    fnames{3,2} = [dir 'wxtail+0re15e5.txt'];
    
    fnames{1,3} = [dir 'wxtail+10re3e5.txt'];
    fnames{2,3} = [dir 'wxtail+10re7e5.txt'];
    fnames{3,3} = [dir 'wxtail+10re15e5.txt'];
